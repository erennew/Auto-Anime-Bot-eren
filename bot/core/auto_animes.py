...
async def get_animes(name, torrent, force=False):
    ...
    try:
        ...
        ep_no = aniInfo.pdata.get("episode_number", 1)  # Default to episode 1 if not found
        ...
        async with ffLock:
            ...
            for qual in Var.QUALS:
                ...
                try:
                    ...
                    await rep.report(f"❌ {qual}p encode failed!\nError: {e}", "error")
                    continue
                ...
                try:
                    ...
                    await rep.report(f"❌ {qual}p upload failed!\nError: {e}", "error")
                    continue
